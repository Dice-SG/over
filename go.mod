...
replace (
	...
	k8s.io/component-helpers => k8s.io/component-helpers v0.19.0
	...
	k8s.io/mount-utils => k8s.io/mount-utils v0.19.0
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.19.0
...
require (
	...
	k8s.io/cloud-provider v0.19.0 // indirect
